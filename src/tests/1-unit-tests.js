...
describe('Testes Unitários:', () => {
    ...
    describe('Encrypt Utils:', () => {
        ...
        describe('#hashEncrypt()', () => {
             ...
             */
            it('Deve hashear a string "texto"', () => {
        ...
        describe('#match()', () => {
            /**
                 ...
                 */
            it('Deve comparar a string "texto" com o hash e retornar "true"', () => {
            ...
            /**
                 ...
                 */
            it('Deve comparar a string "outrotexto" com o hash e retornar "false"', () => {
    ...
    describe('Users Utils:', () => {
        ...
        describe('#userIsNull()', () => {
             ...
             */
            it('Deve checar se o valor é nullo e retornar "false"', () => {
             ...
             */
            it('Deve checar se o valor é nullo e retornar "true"', () => {
         ...
         * @name #userIsNotNull()
         */
        describe('#userIsNotNull()', () => {
            /**
             * Testa se o valor não é nulo e retorna "false".
             * @function
             * @name Deve checar se o valor NÃO é nullo e retornar "false"
             */
            it('Deve checar se o valor NÃO é nullo e retornar "false"', () => {
             ...
             */
            it('Deve checar se o valor NÃO é nullo e retornar "true"', () => {
    ...
    describe('Date Utils:', () => {
        ...
        describe('#getCurrentDate()', () => {
             ...
             */
            it('Deve retornar um objeto do "Date"', () => {
